...
export type EventsLeaveRequest = operations['events___leave']['requestBody']['content']['application/json'];
...
export type EventsParticipateRequest = operations['events___participate']['requestBody']['content']['application/json'];
